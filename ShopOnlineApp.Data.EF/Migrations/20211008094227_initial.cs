        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessAction_Business_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PositionId = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusinessActionId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrantPermission", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GrantPermission_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GrantPermission_BusinessAction_BusinessActionId",
                        column: x => x.BusinessActionId,
                        principalTable: "BusinessAction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessAction_BusinessId",
                table: "BusinessAction",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_GrantPermission_BusinessActionId",
                table: "GrantPermission",
                column: "BusinessActionId");
